...
[^2]: Other rare operating systems / CPUs may exist, but it is not feasible to provide pre-builds for any arbitrary platform under the roof of this project. To do so, we need at least one of the following:
